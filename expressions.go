...
func newIdentifierFunc(name string, col any) exp.SQLFunctionExpression {
...
func DISTINCT(col any) exp.SQLFunctionExpression { return newIdentifierFunc("DISTINCT", col) }
...
//	COUNT("*") -> COUNT("*")
//	COUNT(I("a")) -> COUNT("a")
func COUNT(col any) exp.SQLFunctionExpression { return newIdentifierFunc("COUNT", col) }

// Creates a new MIN sql function
//
//	MIN("a") -> MIN("a")
//	MIN(I("a")) -> MIN("a")
func MIN(col any) exp.SQLFunctionExpression { return newIdentifierFunc("MIN", col) }

// Creates a new MAX sql function
//
//	MAX("a") -> MAX("a")
//	MAX(I("a")) -> MAX("a")
func MAX(col any) exp.SQLFunctionExpression { return newIdentifierFunc("MAX", col) }

// Creates a new AVG sql function
//
//	AVG("a") -> AVG("a")
//	AVG(I("a")) -> AVG("a")
func AVG(col any) exp.SQLFunctionExpression { return newIdentifierFunc("AVG", col) }

// Creates a new FIRST sql function
//
//	FIRST("a") -> FIRST("a")
//	FIRST(I("a")) -> FIRST("a")
func FIRST(col any) exp.SQLFunctionExpression { return newIdentifierFunc("FIRST", col) }

// Creates a new LAST sql function
//
//	LAST("a") -> LAST("a")
//	LAST(I("a")) -> LAST("a")
func LAST(col any) exp.SQLFunctionExpression { return newIdentifierFunc("LAST", col) }

// Creates a new SUM sql function
//
//	SUM("a") -> SUM("a")
//	SUM(I("a")) -> SUM("a")
func SUM(col any) exp.SQLFunctionExpression { return newIdentifierFunc("SUM", col) }
...
// Create a new SQL value ( alias for builder.L("?", val) ). The prrimary use case for this would be in selects.
// See examples.
