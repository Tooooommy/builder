...
type (
	UpdateClauses interface {
		...
		SetValues() any
		HasSetValues() bool
		SetSetValues(values any) UpdateClauses
		...
		SetLimit(limit any) UpdateClauses
...
func (uc *updateClauses) SetValues() any {
	return uc.setValues
}
...
func (uc *updateClauses) SetSetValues(values any) UpdateClauses {
	ret := uc.clone()
...
func (uc *updateClauses) Limit() any {
	return uc.limit
}
...
func (uc *updateClauses) SetLimit(limit any) UpdateClauses {
	ret := uc.clone()
	ret.limit = limit
	return ret
}
