...
func set(col IdentifierExpression, val any) UpdateExpression {
	return update{col: col, val: val}
}

func NewUpdateExpressions(update any) (updates []UpdateExpression, err error) {
