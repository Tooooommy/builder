...
func NewBooleanExpression(op BooleanOperation, lhs Expression, rhs any) BooleanExpression {
...
func notIn(lhs Expression, vals ...any) BooleanExpression {
	if len(vals) == 1 && reflect.Indirect(reflect.ValueOf(vals[0])).Kind() == reflect.Slice {
...
func checkLikeExp(op BooleanOperation, lhs Expression, val any, invert bool) BooleanExpression {
	rhs := val
...
func checkBoolExpType(op BooleanOperation, lhs Expression, rhs any, invert bool) BooleanExpression {
	if rhs == nil {
		op = IsOp
	} else {
