...
**[`DialectWrapper.Update`](https://godoc.org/github.com/Tooooommy/builder/#DialectWrapper.Update)**
...
`builder` will also use fields in embedded structs when creating an update.
