...
type (
	...
	ExpressionSQLGenerator interface {
		Dialect() string
		Generate(b sb.SQLBuilder, val any)
	}
	...
	// See (github.com/Tooooommy/builder/dialect/postgres)
...
func errUnsupportedIdentifierExpression(t any) error {
...
func (esg *expressionSQLGenerator) Generate(b sb.SQLBuilder, val any) {
	if b.Error() != nil {
		return
	}
	if val == nil {
...
func (esg *expressionSQLGenerator) reflectSQL(b sb.SQLBuilder, val any) {
...
func (esg *expressionSQLGenerator) placeHolderSQL(b sb.SQLBuilder, i any) {
