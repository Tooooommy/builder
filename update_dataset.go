...
func newUpdateDataset(d string, executor sqlx.Session) *UpdateDataset {
...
func (ud *UpdateDataset) Exec() (sql.Result, error) {
	return ud.ExecCtx(context.Background())
}

func (ud *UpdateDataset) ExecCtx(ctx context.Context) (sql.Result, error) {
	query, args, err := ud.buildSQL()
	if err != nil {
		return nil, err
	}
	return ud.executor.ExecCtx(ctx, query, args...)
}

func (ud *UpdateDataset) QueryRow(v any) error {
	return ud.QueryRowCtx(context.Background(), v)
}
...
func (ud *UpdateDataset) QueryRowCtx(ctx context.Context, v any) error {
	...
	return ud.executor.QueryRowCtx(ctx, v, query, args...)
}

func (ud *UpdateDataset) QueryRowPartial(v any) error {
	return ud.QueryRowPartialCtx(context.Background(), v)
}
...
func (ud *UpdateDataset) QueryRowPartialCtx(ctx context.Context, v any) error {
	...
	return ud.executor.QueryRowPartialCtx(ctx, v, query, args...)
}

func (ud *UpdateDataset) QueryRows(v any) error {
	return ud.QueryRowsCtx(context.Background(), v)
}
...
func (ud *UpdateDataset) QueryRowsCtx(ctx context.Context, v any) error {
	...
	return ud.executor.QueryRowsCtx(ctx, v, query, args...)
}

func (ud *UpdateDataset) QueryRowsPartial(v any) error {
	return ud.QueryRowsPartialCtx(context.Background(), v)
}
...
func (ud *UpdateDataset) QueryRowsPartialCtx(ctx context.Context, v any) error {
	...
	return ud.executor.QueryRowsPartialCtx(ctx, v, query, args...)
}

func (ud *UpdateDataset) buildSQL() (string, []any, error) {
	if ud.executor == nil {
